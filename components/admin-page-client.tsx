  ...
  if (!unlocked) {
    return (
      <main className="min-h-screen flex items-center justify-center px-4">
        <div className="bg-card border border-border rounded-lg p-7 w-full max-w-md text-center">
          ...
          <div className="mt-5 flex flex-col gap-4">
            ...
            <Button
              ...
              className="bg-seahawks-green hover:bg-seahawks-green/90 text-white font-display font-bold uppercase tracking-wide text-lg h-12"
            >
              Unlock Admin
            </Button>
          </div>
