...
export function CheckoutPanel() {
  ...
  if (gamePhase === "submitted") {
    return (
      <div className="w-full max-w-lg mx-auto">
        <div className="glass-panel rounded-3xl p-6 text-center border border-pending/40">
          <svg
    ...
    return (
      <div className="w-full max-w-lg mx-auto">
        <div className="glass-panel rounded-3xl p-6 shadow-xl">
          ...
          <div className="bg-pending/15 border border-pending/30 rounded-2xl p-4 mb-5">
            <p className="text-pending text-sm sm:text-base font-medium">
              Your squares will be held as PENDING until payment is confirmed. Please send payment after submitting.
            </p>
          </div>
          ...
          <div className="flex flex-col gap-4">
            <Input
              ...
              className="bg-white/5 border border-white/10 text-foreground placeholder:text-muted-foreground h-14 text-base sm:text-lg rounded-xl"
              autoFocus
            />
            <div className="flex gap-3">
              <Button
                ...
                className="flex-1 h-14 border border-white/10 text-foreground hover:text-foreground bg-transparent hover:bg-white/10 rounded-xl text-base sm:text-lg"
              >
                Cancel
              </Button>
              <Button
  ...
  return (
    <div className="w-full max-w-lg mx-auto">
      <div className="glass-panel rounded-3xl p-5 flex items-center justify-between gap-4 shadow-xl">
        <div>
          <p className="text-foreground font-display text-xl sm:text-2xl uppercase tracking-tight">
        ...
        <div className="flex gap-3 shrink-0">
          <Button
            variant="outline"
            onClick={clearSelection}
            className="border border-white/10 text-foreground hover:text-foreground bg-transparent hover:bg-white/10 h-12 px-4 rounded-xl text-base"
          >
            Clear
          </Button>
          <Button
